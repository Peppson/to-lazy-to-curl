...
public static class HttpService
{
    ...
    private static async Task SetHttpResponseText(HttpResponseMessage? response)
    {
            ...
            contentType.Contains("json", StringComparison.OrdinalIgnoreCase))
        {
            ...
            AppState.JsonInput.ResponseEditorText = await GetResponseAsJsonAsync(response); 
            ...
            contentType.Contains("html", StringComparison.OrdinalIgnoreCase))
        {
            ...
            AppState.JsonInput.ResponseEditorText = await response.Content!.ReadAsStringAsync();
